...
#print("Polpulation mean:",statistics.mean(datalist))
#print("Polpulation std:",statistics.stdev(datalist))
...
def show_fig(meanList):
    ...
    fig.add_trace(go.Scatter(x=[mean,mean],y=[0,1],mode="markers+lines",name="Mean"))
    fig.show()
...
#sd  of the sampling mean= 0.5699